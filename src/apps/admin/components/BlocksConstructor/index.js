        ...
        <div className={classes.block}>
            <div className={classes.blocksSide}>
                <Typography variant="h6" className={classes.catalogTitle}>
                    <FormattedMessage id='currentBlocks' />
                </Typography>
                <ReactSortable
                    group="shared"
                    list={blocks}
                    ...
                    {blocks.map((block, i) =>
                        <ListItem key={i} className={classNames(classes.listItem, {
                            ...
                            <InputBase
                                ...
                                value={block.name}
                                onChange={handleBlockNameChange(i)}
                            />
            ...
            <div className={classes.catalogSide}>
                <div className={classes.sticky}>
                    <Typography variant="h6" className={classes.catalogTitle}>
                        <FormattedMessage id='blocksCatalog' />
                    </Typography>
                    <ReactSortable
                        group={{
                            name: 'shared',
                    ...
                    >
                        {props.catalog.map((catalog) =>
                            <ListItem key={catalog.id} className={classes.listItem} divider>
                                <ListItemText
