...
const Row = props => {
    const { isSelected, classes, tableCells, value, sortable } = props;
...
const CustomAdTable = props => {
    const classes = useStyles();
    const { headerRows, tableCells, values, headerText, noActions } = props;
